...
public class DataExchange implements CDProtocol {
    ...
    protected void gracefulDisconnect(Node node, int protocolID, int dType) {
        disconnecting = true;
        //Respond to all RECORD_INFORM with a PEER_DOWN message
        messages.clear();
    ...
    public int countData(String d) {
        return dCount; //Number of elements in dataCollection whose dataID = d
    }
    ...
    public String generateDataElement() {
        return dataElement; //Random character a-z, A-Z, 0-9
    }
